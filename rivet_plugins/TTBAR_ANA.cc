...
namespace Rivet {
  ...
  public:
    ...
    void init() {
      ...
      VetoedFinalState vfs(FinalState(-2.5,2.5,0*GeV));
      ...
      //
      _h_jet_1_pT = bookHisto1D("jet_1_pT", 250,0,1000);
      _h_jet_2_pT = bookHisto1D("jet_2_pT", 250,0,1000);
      _h_jet_3_pT = bookHisto1D("jet_3_pT", 250,0,1000);
      _h_jet_4_pT = bookHisto1D("jet_4_pT", 250,0,1000);
      //
      _h_bjet_1_pT = bookHisto1D("jetb_1_pT", 250,0,1000);
      _h_bjet_2_pT = bookHisto1D("jetb_2_pT", 250,0,1000);
      //
    ...
    void analyze(const Event& event) {
      ...
      if(bjets.size() > 0)
      {
          _h_bjet_1_pT->fill(bjets[0].pT()/GeV,weight);
      }
      if(jets.size() > 0)
      {
