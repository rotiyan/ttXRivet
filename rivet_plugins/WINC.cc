...
namespace Rivet {
  ...
  public:
    ...
    void init() {
      FinalState fs;
      WFinder wfinder(fs, Cuts::abseta < 3.5 & Cuts::pT > 25*GeV, PID::ELECTRON, 0.0*GeV, 100.0*GeV, 25.0*GeV, 0.2);
      addProjection(wfinder, "WFinder");

      _h_W_mass = bookHisto1D("W_mass", 105, 1.0, 105.0);
