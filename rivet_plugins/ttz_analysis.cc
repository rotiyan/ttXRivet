...
namespace Rivet {
  ...
  //kinematic variables
   ...
   normalize( h_el_eta);
   normalize( h_el_phi);
   normalize( h_diEl_mass); 
   normalize( h_diEl_PDG_mass);

   normalize( h_mu_pt);
   normalize( h_mu_eta);
   normalize( h_mu_phi);
   normalize( h_diMu_mass);
   normalize( h_diMu_PDG_mass);
  
   normalize( h_Zboson_pt);
   normalize( h_Zboson_eta);
   normalize( h_Zboson_phi);
   normalize( h_Zboson_b1_dr);
   normalize( h_Zboson_b2_dr);

  
   normalize( h_b1_b2_dEta);
   normalize( h_b1_b2_dPhi);
   normalize( h_b1_b2_dR);

   normalize( h_top_mass);
   normalize( h_top_pt);
   normalize( h_top_eta);
   normalize( h_top_phi);

   normalize( h_top_PDG_mass);
   normalize( h_top_PDG_pt);
   normalize( h_top_PDG_eta);
   normalize( h_top_PDG_phi);


   normalize( h_t1_t2_dEta);
   normalize( h_t1_t2_dPhi);
   normalize( h_t1_t2_dR);
   ...
   normalize( h_w_PDG_mass);
   normalize( h_w_PDG_pt);
   normalize( h_w_PDG_eta);
   normalize( h_w_PDG_phi);

   normalize( h_z_PDG_mass);
   normalize( h_z_PDG_pt);
   normalize( h_z_PDG_eta);
   normalize( h_z_PDG_phi);

   normalize( h_el_PDG_pt);
   normalize( h_el_PDG_eta);
   normalize( h_el_PDG_phi);

   normalize( h_mu_PDG_pt);
   normalize( h_mu_PDG_eta);
   normalize( h_mu_PDG_phi);
