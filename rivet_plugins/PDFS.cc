...
namespace Rivet {
  ...
  public:
    ...
    /// Finalize
    void finalize() {
      scale(_histPdfX, crossSection()/sumOfWeights());
      scale(_histPdfXmin, crossSection()/sumOfWeights());
      scale(_histPdfXmax, crossSection()/sumOfWeights());
      scale(_histPdfQ, crossSection()/sumOfWeights());
    }
